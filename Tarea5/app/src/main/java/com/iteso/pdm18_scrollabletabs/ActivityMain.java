...
public class ActivityMain extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.action_logout:
                toLogin();
                // ir a actividad de login
                // limpiar stack con finish
            break;
            case R.id.action_privacy:
                toPrivacy();
                // ir al webview de privacy
            break;
        }
    ...
    public void toLogin(){
        ...
        editor.clear();
        editor.apply();
        //Log.e("login", "toLogin: llega al intent");
        Intent intent = new Intent(ActivityMain.this,ActivityLogin.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        // limpiar todo el stack del sistema operativo y deja la actual
        startActivity(intent);
        finish(); // por si una version vieja de android no limpia el stack
